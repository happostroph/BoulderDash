...
final class BoulderDashBDDConnector {
	...
	/** The login. */
	private static String user = "Happo";

	/** The password. */
	private static String password = "Happo";

	/** The url. */
	private static String url = "jdbc:mysql://178.62.12.146:3306/boulderdash?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
